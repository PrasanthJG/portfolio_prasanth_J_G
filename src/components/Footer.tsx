      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-muted-foreground mb-6 leading-relaxed">
              Front-End Developer specializing in React.js, responsive design, and creating intuitive user experiences.
            </p>
            <div className="flex space-x-4">
              <a
                href="https://github.com/prasanthjg"
                target="_blank"
                rel="noopener noreferrer"
                className="text-muted-foreground hover:text-primary transition-colors p-2 hover:scale-110 transition-transform"
              >
              ...
              <a
                href="https://linkedin.com/in/prasanthjg"
                target="_blank"
                rel="noopener noreferrer"
                className="text-muted-foreground hover:text-primary transition-colors p-2 hover:scale-110 transition-transform"
              >
            ...
            <ul className="space-y-3">
              <li className="flex items-center space-x-3">
                ...
                <a
                  ...
                  className="text-muted-foreground hover:text-primary transition-colors"
                >
                  prasanthjg56@gmail.com
                </a>
              </li>
              <li className="flex items-center space-x-3">
                <Phone className="h-4 w-4 text-primary" />
                <a
                  href="tel:+916382608201"
                  className="text-muted-foreground hover:text-primary transition-colors"
                >
                  +91 6382608201
                </a>
        ...
        <div className="border-t border-border mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-muted-foreground text-sm mb-4 md:mb-0">
              © {new Date().getFullYear()} Prasanth J G. All rights reserved.
            </p>
            <p className="text-muted-foreground text-sm flex items-center">
              Made with <Heart className="h-4 w-4 text-red-500 mx-1" /> using React & TypeScript
            </p>
